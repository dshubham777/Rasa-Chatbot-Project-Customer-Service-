...
import logging
import time
from typing import Text, Iterable, Optional, Set, Dict, Union
...
_timestamp_of_oldest_pending_change = utils.mp_context().Value(
    ctypes.c_double, _NO_PENDING_CHANGES_TIMESTAMP
)
_timestamp_of_latest_pending_change = utils.mp_context().Value(
    ctypes.c_double, _NO_PENDING_CHANGES_TIMESTAMP
)
